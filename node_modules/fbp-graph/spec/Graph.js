  ...
  describe('loaded from JSON (with case sensitive port names)', function() {
    ...
    describe('renaming a node', function() {
      ...
      it('shouldn\'t be have export going to the old name', function() {
        var exported, exportedNode, exportedPort, exports, i, len, ref, ref1;
        exports = 0;
        ref = g.exports;
        for (i = 0, len = ref.length; i < len; i++) {
          exported = ref[i];
          ref1 = exported["private"].split('.'), exportedNode = ref1[0], exportedPort = ref1[1];
          if (exportedNode === 'foo') {
            exports++;
          }
        }
    ...
    return describe('removing a node', function() {
      ...
      it('shouldn\'t have edges left behind', function() {
        var connections, edge, i, len, ref;
        connections = 0;
        ref = g.edges;
        for (i = 0, len = ref.length; i < len; i++) {
          edge = ref[i];
...
describe('Case Insensitive Graph', function() {
  describe('Graph operations should convert port names to lowercase', function() {
    ...
    g = null;
    beforeEach(function() {
      return g = new lib.graph.Graph('Hola');
    });
